...
public class TeamRepository : ITeamRepository
{
    ...
    public async Task<IEnumerable<Team>> GetAllAsync()
    {
        ...
        return await connection.QueryAsync<Team>(sql).ConfigureAwait(false);
    }
    ...
    public async Task<Team?> GetByIdAsync(string externalId, string source)
    {
        ...
        return await connection.QuerySingleOrDefaultAsync<Team>(sql, new { ExternalId = externalId, Source = source }).ConfigureAwait(false);
    }
    ...
    public async Task<int> InsertAsync(Team team)
    {
        ...
        return await connection.ExecuteAsync(sql, team).ConfigureAwait(false);
    }
