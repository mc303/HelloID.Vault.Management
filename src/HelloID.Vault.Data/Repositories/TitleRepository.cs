...
public class TitleRepository : ITitleRepository
{
    ...
    public async Task<IEnumerable<Title>> GetAllAsync()
    {
        ...
        return await connection.QueryAsync<Title>(sql);
    }
    ...
    public async Task<Title?> GetByIdAsync(string externalId, string source)
    {
        ...
        return await connection.QuerySingleOrDefaultAsync<Title>(sql, new { ExternalId = externalId, Source = source });
    }
    ...
    public async Task<int> InsertAsync(Title title)
    {
        ...
        return await connection.ExecuteAsync(sql, title);
    }
