...
{
    private EmployersViewModel? _viewModel;
    ...
    {
        System.Diagnostics.Debug.WriteLine("[EmployersView] ===== EmployersView_Loaded START =====");
        ...
        if (dataGrid != null)
        {
            ...
            if (DataContext is EmployersViewModel viewModel)
            {
        ...
        System.Diagnostics.Debug.WriteLine("[EmployersView] ===== EmployersView_Loaded END =====");
    }

    private void OnUnloaded(object sender, RoutedEventArgs e)
    {
        System.Diagnostics.Debug.WriteLine("[EmployersView] ===== EmployersView_Unloaded START =====");
        ...
        System.Diagnostics.Debug.WriteLine("[EmployersView] ===== EmployersView_Unloaded END =====");
    }
