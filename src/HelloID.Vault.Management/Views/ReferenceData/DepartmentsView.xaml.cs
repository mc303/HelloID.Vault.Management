...
public partial class DepartmentsView : UserControl
{
    ...
    {
        System.Diagnostics.Debug.WriteLine("[DepartmentsView] ===== DepartmentsView_Loaded START =====");
        ...
        if (dataGrid != null)
        {
            ...
            if (DataContext is DepartmentsViewModel viewModel)
            {
        ...
        System.Diagnostics.Debug.WriteLine("[DepartmentsView] ===== DepartmentsView_Loaded END =====");
    }

    private void OnUnloaded(object sender, RoutedEventArgs e)
    {
        System.Diagnostics.Debug.WriteLine("[DepartmentsView] ===== DepartmentsView_Unloaded START =====");
        ...
        System.Diagnostics.Debug.WriteLine("[DepartmentsView] ===== DepartmentsView_Unloaded END =====");
    }
    ...
    private void ApplyColumnOrderAndWidths(DataGrid dataGrid)
    {
        ...
        System.Diagnostics.Debug.WriteLine("[DepartmentsView] ApplyColumnOrderAndWidths() START");

        // Apply saved column order
        var savedOrder = _viewModel.GetSavedColumnOrder();
        if (savedOrder != null && savedOrder.Count > 0)
        {
            System.Diagnostics.Debug.WriteLine($"[DepartmentsView] Applying {savedOrder.Count} column order");
            ...
            for (int i = 0; i < savedOrder.Count && i < dataGrid.Columns.Count; i++)
            {
                ...
                if (column != null)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"[DepartmentsView] Set column '{columnName}' DisplayIndex to {i}");
                }
            }
        }
        ...
        {
            System.Diagnostics.Debug.WriteLine($"[DepartmentsView] Applying {savedWidths.Count} column widths");
            ...
            foreach (var kvp in savedWidths)
            {
                ...
                if (column != null)
                {
                    ...
                    System.Diagnostics.Debug.WriteLine($"[DepartmentsView] Set column '{kvp.Key}' width to {kvp.Value}px");
                }
            }
        }

        System.Diagnostics.Debug.WriteLine("[DepartmentsView] ApplyColumnOrderAndWidths() END");
    }
    ...
    private void SaveColumnOrderAndWidths(DataGrid dataGrid)
    {
        ...
        System.Diagnostics.Debug.WriteLine("[DepartmentsView] SaveColumnOrderAndWidths() START");
        ...
        if (columnOrder.Count > 0)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"[DepartmentsView] Saved {columnOrder.Count} column order");
        }
        ...
        if (columnWidths.Count > 0)
        {
            ...
            System.Diagnostics.Debug.WriteLine($"[DepartmentsView] Saved {columnWidths.Count} column widths");
        }

        System.Diagnostics.Debug.WriteLine("[DepartmentsView] SaveColumnOrderAndWidths() END");
    }
