...
public partial class CostBearersView : UserControl
{
    private CostBearersViewModel? _viewModel;

    public CostBearersView()
    {
        InitializeComponent();
        Loaded += OnLoaded;
        Unloaded += OnUnloaded;
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        if (dataGrid != null)
        {
            ...
            if (DataContext is CostBearersViewModel viewModel)
            {
