...
public partial class DivisionsView : UserControl
{
    ...
    {
        System.Diagnostics.Debug.WriteLine("[DivisionsView] ===== DivisionsView_Loaded START =====");
        ...
        if (dataGrid != null)
        {
            ...
            if (DataContext is DivisionsViewModel viewModel)
            {
        ...
        System.Diagnostics.Debug.WriteLine("[DivisionsView] ===== DivisionsView_Loaded END =====");
    }

    private void OnUnloaded(object sender, RoutedEventArgs e)
    {
        System.Diagnostics.Debug.WriteLine("[DivisionsView] ===== DivisionsView_Unloaded START =====");
        ...
        System.Diagnostics.Debug.WriteLine("[DivisionsView] ===== DivisionsView_Unloaded END =====");
    }
