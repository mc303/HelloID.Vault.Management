...
/// <summary>
/// Interaction logic for SourceSystemsView.xaml
/// </summary>
public partial class SourceSystemsView : UserControl
{
    private SourceSystemsViewModel? _viewModel;

    public SourceSystemsView()
    {
        InitializeComponent();
        Loaded += OnLoaded;
        Unloaded += OnUnloaded;
    ...
    private void OnLoaded(object sender, RoutedEventArgs e)
    {
        ...
        if (dataGrid != null)
        {
            ...
            if (DataContext is SourceSystemsViewModel viewModel)
            {
