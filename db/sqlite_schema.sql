...
-- Create full-text search virtual tables for better search performance
...
CREATE TRIGGER persons_fts_insert AFTER INSERT ON persons BEGIN
    INSERT INTO persons_fts(person_id, display_name, external_id, user_name, family_name, given_name)
